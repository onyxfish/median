...
|--------|------|-----|-----|
|median|tweet|`location`||
|median|facebook|`location`||
|median|email|`location`||
|median|new-comment||
|median|open-share-discuss||
|median|close-share-discuss||
|median|summary-copied||
|median|featured-tweet-action|`action`|
|median|featured-facebook-action|`action`|
